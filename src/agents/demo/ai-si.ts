...
export const AI_SI_DESIGNS = [
  ...
  { title: "PRE-AGI", collection: "AGI", concept: "Era marker set like a historical period label, dating the wearer to the years before general intelligence.", front: "Left chest era stamp", back: "Timeline with a single marked point", sleeve: null, method: "puff_embroidery" as const },
